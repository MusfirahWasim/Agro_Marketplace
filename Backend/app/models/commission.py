from sqlalchemy import Column, DECIMAL, ForeignKey, ForeignKeyConstraint
...
class Commission(Base):
    ...
    def __repr__(self):
        return f"<Commission commission_id={self.commission_id} commission_amount={self.commission_amount}>"
