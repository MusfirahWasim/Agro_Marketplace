    ...
    return (
      <div className="font-body flex flex-col items-center justify-center py-24 text-center" style={{ backgroundColor: COLORS.cream }}>
        ...
        <p className="text-sm mb-6" style={{ color: COLORS.sub }}>
          This consignment may no longer be available.
        </p>
        <button
        ...
        <div className="lg:col-span-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs" style={{ color: COLORS.sub }}>Supplied by</p>
                <p className="text-sm font-medium" style={{ color: COLORS.ink }}>{product.supplier}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs" style={{ color: COLORS.sub }}>Consigned via</p>
                <p className="text-sm font-medium" style={{ color: COLORS.ink }}>{product.agent}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <p className="text-sm" style={{ color: COLORS.sub }}>
              Subtotal: <span className="font-medium" style={{ color: COLORS.ink }}>Rs {lineTotal.toLocaleString()}</span>
            </p>
          </div>
